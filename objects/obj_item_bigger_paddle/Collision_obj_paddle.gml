...
{
	image_xscale = 1.5;														// obj_paddle Größe wird aud 1.5 gestellt.
...
instance_create_layer(280, 31, "Instances", obj_item_board_bigger_paddle)	// obj_item_board_bigger_paddle wird erstellt.
